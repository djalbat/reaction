  ...
  var require_filterLink = __commonJS((exports) => {
    ...
    var FilterLink = /* @__PURE__ */ function(Component2) {
      ...
      function FilterLink2() {
        ...
        var _this;
        _this = _call_super(this, FilterLink2, arguments), _define_property(_this, "updateHandler", function() {
          _this.forceUpdate();
        });
        return _this;
      }
